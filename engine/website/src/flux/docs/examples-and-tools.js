...
var Post = React.createClass({
  ...
  render: function() {
    return <Layout metadata={{"id":"examples-and-tools","title":"Examples and Tools","layout":"docs","category":"Community Resources","permalink":"docs/examples-and-tools.html","next":"react"}}>{content}</Layout>;
  }
});
module.exports = Post;
