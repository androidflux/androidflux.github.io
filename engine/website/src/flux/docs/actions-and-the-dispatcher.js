...
var Post = React.createClass({
  ...
  render: function() {
    return <Layout metadata={{"id":"actions-and-the-dispatcher","title":"Actions and the Dispatcher","layout":"docs","category":"Guides","permalink":"docs/actions-and-the-dispatcher.html","next":"testing-flux-applications"}}>{content}</Layout>;
  }
});
module.exports = Post;
