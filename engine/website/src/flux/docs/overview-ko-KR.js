...
var Post = React.createClass({
  ...
  render: function() {
    return <Layout metadata={{"id":"overview-ko-KR","title":"개요","layout":"docs","category":"Quick Start","permalink":"docs/overview-ko-KR.html","next":"todo-list-ko-KR","lang":"ko-KR"}}>{content}</Layout>;
  }
});
module.exports = Post;
