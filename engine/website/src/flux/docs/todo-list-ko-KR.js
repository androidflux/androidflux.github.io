...
var Post = React.createClass({
  ...
  render: function() {
    return <Layout metadata={{"id":"todo-list-ko-KR","title":"튜토리얼 – 할 일 목록","layout":"docs","category":"Quick Start","permalink":"docs/todo-list-ko-KR.html","next":"chat-ko-KR","lang":"ko-KR"}}>{content}</Layout>;
  }
});
module.exports = Post;
