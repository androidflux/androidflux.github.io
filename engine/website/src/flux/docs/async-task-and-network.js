...
var Post = React.createClass({
  ...
  render: function() {
    return <Layout metadata={{"id":"async-task-and-network","title":"异步操作和网络","layout":"docs","category":"Guides","permalink":"docs/async-task-and-network.html","next":"store-and-data-persistence"}}>{content}</Layout>;
  }
});
module.exports = Post;
