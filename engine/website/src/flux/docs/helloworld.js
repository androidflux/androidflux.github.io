...
var Post = React.createClass({
  ...
  render: function() {
    return <Layout metadata={{"id":"helloworld","title":"Tutorial - Hello World","layout":"docs","category":"Quick Start","permalink":"docs/helloworld.html","next":"todo-list"}}>{content}</Layout>;
  }
});
module.exports = Post;
