...
var Post = React.createClass({
  ...
  render: function() {
    return <Layout metadata={{"id":"videos-ko-KR","title":"비디오","layout":"docs","category":"Community Resources","permalink":"docs/videos-ko-KR.html","next":"examples-and-tools-ko-KR","lang":"ko-KR"}}>{content}</Layout>;
  }
});
module.exports = Post;
