...
var Post = React.createClass({
  ...
  render: function() {
    return <Layout metadata={{"id":"testing-flux-applications","title":"Testing Flux Applications","layout":"docs","category":"Guides","permalink":"docs/testing-flux-applications.html","next":"dispatcher"}}>{content}</Layout>;
  }
});
module.exports = Post;
