...
var Post = React.createClass({
  ...
  render: function() {
    return <Layout metadata={{"id":"examples-and-tools-ko-KR","title":"예제와 도구","layout":"docs","category":"Community Resources","permalink":"docs/examples-and-tools-ko-KR.html","next":"react-ko-KR","lang":"ko-KR"}}>{content}</Layout>;
  }
});
module.exports = Post;
