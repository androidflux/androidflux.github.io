...
var Post = React.createClass({
  ...
  render: function() {
    return <Layout metadata={{"id":"testing-flux-applications-ko-KR","title":"Flux 애플리케이션 테스팅","layout":"docs","category":"Guides","permalink":"docs/testing-flux-applications-ko-KR.html","next":"dispatcher-ko-KR","lang":"ko-KR"}}>{content}</Layout>;
  }
});
module.exports = Post;
