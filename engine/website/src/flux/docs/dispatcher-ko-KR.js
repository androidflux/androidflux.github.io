...
var Post = React.createClass({
  ...
  render: function() {
    return <Layout metadata={{"id":"dispatcher-ko-KR","title":"Dispatcher","layout":"docs","category":"Reference","permalink":"docs/dispatcher-ko-KR.html","next":"videos-ko-KR","lang":"ko-KR"}}>{content}</Layout>;
  }
});
module.exports = Post;
