...
var Post = React.createClass({
  ...
  render: function() {
    return <Layout metadata={{"id":"videos","title":"Videos","layout":"docs","category":"Community Resources","permalink":"docs/videos.html","next":"examples-and-tools"}}>{content}</Layout>;
  }
});
module.exports = Post;
