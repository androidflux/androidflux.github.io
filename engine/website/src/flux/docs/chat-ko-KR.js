...
var Post = React.createClass({
  ...
  render: function() {
    return <Layout metadata={{"id":"chat-ko-KR","title":"튜토리얼 – Chat","layout":"docs","category":"Quick Start","permalink":"docs/chat-ko-KR.html","next":"actions-and-the-dispatcher-ko-KR","lang":"ko-KR"}}>{content}</Layout>;
  }
});
module.exports = Post;
