...
var Post = React.createClass({
  ...
  render: function() {
    return <Layout metadata={{"id":"actions-and-the-dispatcher-ko-KR","title":"Action과 Dispatcher","layout":"docs","category":"Guides","permalink":"docs/actions-and-the-dispatcher-ko-KR.html","next":"testing-flux-applications-ko-KR","lang":"ko-KR"}}>{content}</Layout>;
  }
});
module.exports = Post;
